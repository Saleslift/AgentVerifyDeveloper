/*
  # Fix Agent Properties Policies

  1. Changes
    - Drop existing policies
    - Create new policies for marketplace properties
...
CREATE POLICY "Enable marketplace property additions"
ON agent_properties
FOR INSERT
TO authenticated
WITH CHECK (
...
CREATE POLICY "Enable property viewing"
ON agent_properties
FOR SELECT
TO authenticated
USING (
