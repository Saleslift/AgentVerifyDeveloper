...
-- Create or replace function to create notification when a new meeting is scheduled
...
-- Create or replace function to log meeting creation in activity log
