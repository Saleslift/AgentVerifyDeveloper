/*
  # Fix Deal Chat Notifications

  1. Changes
    - Fix the create_chat_notification function to ensure message is never null
    - Update the trigger to handle message content properly
