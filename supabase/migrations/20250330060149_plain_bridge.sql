...
DO $$
BEGIN
  DROP POLICY IF EXISTS "Super admins can upload homepage assets" ON storage.objects;
  DROP POLICY IF EXISTS "Super admins can update homepage assets" ON storage.objects;
  DROP POLICY IF EXISTS "Super admins can delete homepage assets" ON storage.objects;
